    ...
    <div className="carousel w-full md:max-h-[80vh] ">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute h-full w-full flex items-center  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-2 md:space-y-6 w-3/4 md:w-1/2 ml-2  md:ml-8 ">
            ...
            <div className="flex gap-2 md:gap-4">
              <CommonButton label={"Discover More"}></CommonButton>
              <button>
                <button className="btn hover:bg-opacity-30 text-white btn-outline hover:border-[#FF3811] ">
                  Latest Project
                </button>
              </button>
            </div>
        ...
        <div className="absolute  md:right-10 right-2 gap-2 md:gap-4 -bottom-5 md:bottom-0 flex -translate-y-1/2 transform justify-end">
          <a
            href="#slide4"
            className="btn hover:bg-opacity-40 border-none bg-opacity-50 btn-circle text-white"
          >
            ❮
          </a>
          <a
            href="#slide2"
            className="btn hover:bg-[rgb(255,100,17)] border-none bg-[#FF3811] btn-circle text-white"
          >
            ❯
          </a>
        </div>
      ...
      <div id="slide4" className="carousel-item relative w-full">
        ...
        <div className="absolute h-full w-full flex items-center  bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-2 md:space-y-6 w-3/4 md:w-1/2 ml-2  md:ml-8 ">
            ...
            <CommonButton label={"Discover More"}></CommonButton>
              <button>
                <button className="btn hover:bg-opacity-30 text-white hover:border-[#FF3811] btn-outline">
                  Latest Project
                </button>
              </button>
            </div>
